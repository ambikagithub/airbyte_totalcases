...
select
    ...
    cast({{ adapter.quote('Date/Time Closed') }} as {{ dbt_utils.type_string() }}) as {{ adapter.quote('Date/Time Closed') }},
    cast({{ adapter.quote('Date/Time Opened') }} as {{ dbt_utils.type_string() }}) as {{ adapter.quote('Date/Time Opened') }},
